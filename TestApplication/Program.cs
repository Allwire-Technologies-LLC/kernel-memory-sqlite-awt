...
internal class Program
{
    ...
    public static async Task Main()
    {
        ...
        await memoryPlugin["SaveFile"].InvokeAsync(context).ConfigureAwait(false);
        ...
        FunctionResult answer = await oracleFunction.InvokeAsync(Question1, kernel).ConfigureAwait(false);
        Console.WriteLine("Answer: " + answer);

        Console.WriteLine("---------");
        Console.WriteLine(Question2 + "\n");
        answer = await oracleFunction.InvokeAsync(Question2, kernel).ConfigureAwait(false);
        Console.WriteLine("Answer: " + answer);

        Console.WriteLine("---------");
        Console.WriteLine(Question3 + "\n");
        answer = await oracleFunction.InvokeAsync(Question3, kernel).ConfigureAwait(false);
        Console.WriteLine("Answer: " + answer);
    }
